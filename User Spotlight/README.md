...
The streamer can create a Spotlight action for select users. This action can do something as simple as posting a message
...
- spotlightIntervalMinutes - The time to wait in between Spotlights
